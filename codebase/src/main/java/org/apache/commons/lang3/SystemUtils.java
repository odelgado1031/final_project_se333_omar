...
public class SystemUtils {
     ...
     */
    public static boolean isJavaVersionAtLeast(final JavaVersion required) {
    // On newer JDKs this older enum may not recognize the version and be null.
    final JavaVersion current = JAVA_SPECIFICATION_VERSION_AS_ENUM;
    if (current == null) {
        // Treat unknown (newer) runtime as >= any known version in this enum.
        return true;
    }
